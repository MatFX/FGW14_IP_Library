...
import eu.matfx.request.system.network.ethernet.SetStaticEthernetIPRequest;
...
public class SetStaticWlanIPTest 
{
	
	public static void main(String[] args) throws IOException
	{
		SetStaticWlanIPRequest ipRequest = new SetStaticWlanIPRequest();
